...
tag_freqs, tag_names, vectors = pickle.load(gzip.open(os.path.join(base_path, "TuneAnnotationsSyn.pkl.gz"), "rb"),
                                            encoding='latin1')
